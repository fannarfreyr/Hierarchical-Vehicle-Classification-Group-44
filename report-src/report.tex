...
\end{itemize}
\subsection{Data and Class Balancing on 2 Head (Model, Make}
\begin{itemize}
	\item \textbf{Objective:} Make the model to perform better on more rare classes
	\item \textbf{Data:} While the 2 head model with Data augmentation the Model Head got 85.65\% and the Make Head got 92,.1\% accuracy after class balancing the Model Head increased to 86.02\% the Make Head decreased to 91.77\%.
...
\begin{itemize}
	...
	\item \textbf{Data:} Contrast Experiment 6 (3-Head No Curriculum Learning: 85.36\%) vs. Experiment 7 (3-Head With Curriculum Learning: 86.15\%).
...
\begin{itemize}
	\item \textbf{Objective:} Solving the overfitting problem. 
	\item \textbf{Data:} Compare Experiment 8 (2-Head Curriculum: 86.49\%) against Experiment 7 (3-Head Curriculum: 86.15\% - initial) and Experiment 9/10 (Final 3-Head: 87,95\%).
...
\begin{itemize}
	...
	\item \textbf{Data:} After implementing 5 Test Time Augmentation the model reached 88,57\% accuracy which is the best could squeeze out.
