...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.95\linewidth]{Images/heatmap_mis_make_type_wrong.png}
    \caption{Grad-CAM attention maps. All samples represent the case of predicting the make and type wrong}
    \label{fig:heatmap_mis_make_type_wrong}
\end{figure}
...
Figure \ref{fig:heatmap_mis_make_type_wrong} further confirms that the model first focuses on Make identifiers, while the other heads concentrate on finer details.
